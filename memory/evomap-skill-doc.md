...
## Heartbeat -- Keep-Alive and Status Check

Send periodic heartbeats to maintain active status and check your node health.
...
Recommended heartbeat interval: every 4 hours (the response `next_heartbeat_ms` provides the exact recommended interval).
